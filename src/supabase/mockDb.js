...
export const mockDb = {
  profiles: [
    ...
    { id: 'dev-user', username: 'Developer', full_name: 'Local Dev', avatar_url: 'https://api.dicebear.com/7.x/pixel-art/svg?seed=Dev' }
  ],
  banners: [
    { id: 1, title: 'Welcome to Happytalk', image_url: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200' },
    { id: 2, title: 'Connect with Friends', image_url: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1200' },
    { id: 3, title: 'Explore Demo Mode', image_url: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1200' }
  ],
  messages: [
    ...
    { id: 2, conversation_id: 'conv1', user_id: 'mock-user-1234', text: 'Looks smooth!', created_at: new Date().toISOString() }
  ],
  conversations: [
  ...
  posts: [
    { id: 'post-1', user_id: 'dev-user', title: 'Running in Demo Mode', content: 'The site is now fully functional even without Supabase keys!', created_at: new Date().toISOString() }
  ]
};
